...
# Create product
@router.post('/product', status_code=status.HTTP_201_CREATED, tags=['Product'], response_model=schemas.DisplayProduct)
...
# Read all products
@router.get('/products', response_model=List[schemas.DisplayProduct], tags=['Product'])
